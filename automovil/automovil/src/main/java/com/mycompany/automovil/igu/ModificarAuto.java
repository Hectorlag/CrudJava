...
public class ModificarAuto extends javax.swing.JFrame {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        //TRAEMOS LOS DATOS DEL AUTO
         ...
         control.modificarAuto(a, modelo, marca, color, motor, patente, cantPuertas);
         
         mostrarMensaje("SE MODIFICO CORRECTAMENTE", "INFO", "Modificación Exitosa");
    ...
    private void cargarDatosAuto(int idAuto) {
        ...
        txtMotor.setText(a.getMotor());
        txtPatente.setText(a.getPatente());
        txtCantPuertas.setText(String.valueOf(a.getNum_Puertas()));
    }
}
